[gd-sprest](../README.md) > ["lib/list"](../modules/_lib_list_.md) > [_List](../classes/_lib_list_._list.md)
...
* [constructor](_lib_list_._list.md#constructor)


### Properties

* [defaultToWebFl](_lib_list_._list.md#defaulttowebfl)
* [existsFl](_lib_list_._list.md#existsfl)
* [getAllItemsFl](_lib_list_._list.md#getallitemsfl)
* [parent](_lib_list_._list.md#parent)
* [request](_lib_list_._list.md#request)
* [requestType](_lib_list_._list.md#requesttype)
* [responses](_lib_list_._list.md#responses)
* [targetInfo](_lib_list_._list.md#targetinfo)


### Accessors

* [response](_lib_list_._list.md#response)


### Methods

* [addMethods](_lib_list_._list.md#addmethods)
* [done](_lib_list_._list.md#done)
* [execute](_lib_list_._list.md#execute)
* [executeAndWait](_lib_list_._list.md#executeandwait)
* [executeMethod](_lib_list_._list.md#executemethod)
* [executeRequest](_lib_list_._list.md#executerequest)
* [getInfo](_lib_list_._list.md#getinfo)
* [getNextSetOfResults](_lib_list_._list.md#getnextsetofresults)
* [getProperty](_lib_list_._list.md#getproperty)
* [then](_lib_list_._list.md#then)
* [updateDataObject](_lib_list_._list.md#updatedataobject)
* [getByEntityName](_lib_list_._list.md#getbyentityname)
...
### ⊕ **new _List**(listName: *`any`*, targetInfo?: *`any`*): [_List](_lib_list_._list.md)



*Overrides [Base](_utils_base_.base.md).[constructor](_utils_base_.base.md#constructor)*

*Defined in [lib/list.ts:9](https://github.com/gunjandatta/sprest/blob/3de79f1/src/lib/list.ts#L9)*
...
**Returns:** [_List](_lib_list_._list.md)
...
### «Static» getByEntityName

► **getByEntityName**(entityTypeName: *`any`*, callback: *`any`*, targetInfo?: *`any`*): [IListQueryResult](../interfaces/_definitions_list_list_.ilistqueryresult.md)⎮[IResults](../interfaces/_definitions_lib_types_.iresults.md)[IListQueryResult](../interfaces/_definitions_list_list_.ilistqueryresult.md)




*Defined in [lib/list.ts:26](https://github.com/gunjandatta/sprest/blob/3de79f1/src/lib/list.ts#L26)*
...
**Returns:** [IListQueryResult](../interfaces/_definitions_list_list_.ilistqueryresult.md)⎮[IResults](../interfaces/_definitions_lib_types_.iresults.md)[IListQueryResult](../interfaces/_definitions_list_list_.ilistqueryresult.md)
