[gd-sprest](../README.md) > ["lib/site"](../modules/_lib_site_.md) > [_Site](../classes/_lib_site_._site.md)
...
* [constructor](_lib_site_._site.md#constructor)


### Properties

* [defaultToWebFl](_lib_site_._site.md#defaulttowebfl)
* [existsFl](_lib_site_._site.md#existsfl)
* [getAllItemsFl](_lib_site_._site.md#getallitemsfl)
* [parent](_lib_site_._site.md#parent)
* [request](_lib_site_._site.md#request)
* [requestType](_lib_site_._site.md#requesttype)
* [responses](_lib_site_._site.md#responses)
* [targetInfo](_lib_site_._site.md#targetinfo)


### Accessors

* [response](_lib_site_._site.md#response)


### Methods

* [addMethods](_lib_site_._site.md#addmethods)
* [done](_lib_site_._site.md#done)
* [execute](_lib_site_._site.md#execute)
* [executeAndWait](_lib_site_._site.md#executeandwait)
* [executeMethod](_lib_site_._site.md#executemethod)
* [executeRequest](_lib_site_._site.md#executerequest)
* [getInfo](_lib_site_._site.md#getinfo)
* [getNextSetOfResults](_lib_site_._site.md#getnextsetofresults)
* [getProperty](_lib_site_._site.md#getproperty)
* [getRootWeb](_lib_site_._site.md#getrootweb)
* [hasAccess](_lib_site_._site.md#hasaccess)
* [then](_lib_site_._site.md#then)
* [updateDataObject](_lib_site_._site.md#updatedataobject)
...
### ⊕ **new _Site**(url?: *`any`*, targetInfo?: *`any`*): [_Site](_lib_site_._site.md)



*Overrides [Base](_utils_base_.base.md).[constructor](_utils_base_.base.md#constructor)*

*Defined in [lib/site.ts:9](https://github.com/gunjandatta/sprest/blob/3de79f1/src/lib/site.ts#L9)*
...
**Returns:** [_Site](_lib_site_._site.md)
...
► **getRootWeb**(): [IWeb](../interfaces/_definitions_site_web_.iweb.md)




*Defined in [lib/site.ts:32](https://github.com/gunjandatta/sprest/blob/3de79f1/src/lib/site.ts#L32)*
...
*Defined in [lib/site.ts:35](https://github.com/gunjandatta/sprest/blob/3de79f1/src/lib/site.ts#L35)*
