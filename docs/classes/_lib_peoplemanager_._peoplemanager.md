[gd-sprest](../README.md) > ["lib/peopleManager"](../modules/_lib_peoplemanager_.md) > [_PeopleManager](../classes/_lib_peoplemanager_._peoplemanager.md)
...
* [constructor](_lib_peoplemanager_._peoplemanager.md#constructor)


### Properties

* [defaultToWebFl](_lib_peoplemanager_._peoplemanager.md#defaulttowebfl)
* [existsFl](_lib_peoplemanager_._peoplemanager.md#existsfl)
* [getAllItemsFl](_lib_peoplemanager_._peoplemanager.md#getallitemsfl)
* [parent](_lib_peoplemanager_._peoplemanager.md#parent)
* [request](_lib_peoplemanager_._peoplemanager.md#request)
* [requestType](_lib_peoplemanager_._peoplemanager.md#requesttype)
* [responses](_lib_peoplemanager_._peoplemanager.md#responses)
* [targetInfo](_lib_peoplemanager_._peoplemanager.md#targetinfo)


### Accessors

* [response](_lib_peoplemanager_._peoplemanager.md#response)


### Methods

* [addMethods](_lib_peoplemanager_._peoplemanager.md#addmethods)
* [done](_lib_peoplemanager_._peoplemanager.md#done)
* [execute](_lib_peoplemanager_._peoplemanager.md#execute)
* [executeAndWait](_lib_peoplemanager_._peoplemanager.md#executeandwait)
* [executeMethod](_lib_peoplemanager_._peoplemanager.md#executemethod)
* [executeRequest](_lib_peoplemanager_._peoplemanager.md#executerequest)
* [getInfo](_lib_peoplemanager_._peoplemanager.md#getinfo)
* [getNextSetOfResults](_lib_peoplemanager_._peoplemanager.md#getnextsetofresults)
* [getProperty](_lib_peoplemanager_._peoplemanager.md#getproperty)
* [then](_lib_peoplemanager_._peoplemanager.md#then)
* [updateDataObject](_lib_peoplemanager_._peoplemanager.md#updatedataobject)
...
### ⊕ **new _PeopleManager**(targetInfo?: *`any`*): [_PeopleManager](_lib_peoplemanager_._peoplemanager.md)



*Overrides [Base](_utils_base_.base.md).[constructor](_utils_base_.base.md#constructor)*

*Defined in [lib/peopleManager.ts:7](https://github.com/gunjandatta/sprest/blob/3de79f1/src/lib/peopleManager.ts#L7)*
...
**Returns:** [_PeopleManager](_lib_peoplemanager_._peoplemanager.md)
