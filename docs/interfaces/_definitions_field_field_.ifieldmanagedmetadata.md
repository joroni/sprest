[gd-sprest](../README.md) > ["definitions/field/field"](../modules/_definitions_field_field_.md) > [IFieldManagedMetadata](../interfaces/_definitions_field_field_.ifieldmanagedmetadata.md)



# Interface: IFieldManagedMetadata
...
↳  [IFieldLookup](_definitions_field_field_.ifieldlookup.md)

**↳ IFieldManagedMetadata**
...
## Properties
<a id="allowmultiplevalues"></a>

###  AllowMultipleValues

**●  AllowMultipleValues**:  *`boolean`* 

*Inherited from [IFieldLookup](_definitions_field_field_.ifieldlookup.md).[AllowMultipleValues](_definitions_field_field_.ifieldlookup.md#allowmultiplevalues)*

*Defined in [definitions/field/field.ts:231](https://github.com/gunjandatta/sprest/blob/3de79f1/src/definitions/field/field.ts#L231)*
...
<a id="isanchorvalid"></a>

###  IsAnchorValid

**●  IsAnchorValid**:  *`boolean`* 

*Defined in [definitions/field/field.ts:260](https://github.com/gunjandatta/sprest/blob/3de79f1/src/definitions/field/field.ts#L260)*
...
<a id="isdependentlookup"></a>

###  IsDependentLookup

**●  IsDependentLookup**:  *`boolean`* 

*Inherited from [IFieldLookup](_definitions_field_field_.ifieldlookup.md).[IsDependentLookup](_definitions_field_field_.ifieldlookup.md#isdependentlookup)*

*Defined in [definitions/field/field.ts:234](https://github.com/gunjandatta/sprest/blob/3de79f1/src/definitions/field/field.ts#L234)*
...
*Defined in [definitions/field/field.ts:263](https://github.com/gunjandatta/sprest/blob/3de79f1/src/definitions/field/field.ts#L263)*
...
<a id="ispathrendered"></a>

###  IsPathRendered

**●  IsPathRendered**:  *`boolean`* 

*Defined in [definitions/field/field.ts:266](https://github.com/gunjandatta/sprest/blob/3de79f1/src/definitions/field/field.ts#L266)*
...
*Inherited from [IFieldLookup](_definitions_field_field_.ifieldlookup.md).[IsRelationship](_definitions_field_field_.ifieldlookup.md#isrelationship)*

*Defined in [definitions/field/field.ts:237](https://github.com/gunjandatta/sprest/blob/3de79f1/src/definitions/field/field.ts#L237)*
...
<a id="istermsetvalid"></a>

###  IsTermSetValid

**●  IsTermSetValid**:  *`boolean`* 

*Defined in [definitions/field/field.ts:269](https://github.com/gunjandatta/sprest/blob/3de79f1/src/definitions/field/field.ts#L269)*
...
*Inherited from [IFieldLookup](_definitions_field_field_.ifieldlookup.md).[LookupField](_definitions_field_field_.ifieldlookup.md#lookupfield)*

*Defined in [definitions/field/field.ts:240](https://github.com/gunjandatta/sprest/blob/3de79f1/src/definitions/field/field.ts#L240)*
...
*Inherited from [IFieldLookup](_definitions_field_field_.ifieldlookup.md).[LookupList](_definitions_field_field_.ifieldlookup.md#lookuplist)*

*Defined in [definitions/field/field.ts:243](https://github.com/gunjandatta/sprest/blob/3de79f1/src/definitions/field/field.ts#L243)*
...
*Inherited from [IFieldLookup](_definitions_field_field_.ifieldlookup.md).[LookupWebId](_definitions_field_field_.ifieldlookup.md#lookupwebid)*

*Defined in [definitions/field/field.ts:246](https://github.com/gunjandatta/sprest/blob/3de79f1/src/definitions/field/field.ts#L246)*
...
<a id="pinnedtofilterspane"></a>

###  PinnedToFiltersPane

**●  PinnedToFiltersPane**:  *`boolean`* 

*Defined in [definitions/field/field.ts:272](https://github.com/gunjandatta/sprest/blob/3de79f1/src/definitions/field/field.ts#L272)*
...
<a id="primaryfieldid"></a>

###  PrimaryFieldId

**●  PrimaryFieldId**:  *`string`* 

*Inherited from [IFieldLookup](_definitions_field_field_.ifieldlookup.md).[PrimaryFieldId](_definitions_field_field_.ifieldlookup.md#primaryfieldid)*

*Defined in [definitions/field/field.ts:249](https://github.com/gunjandatta/sprest/blob/3de79f1/src/definitions/field/field.ts#L249)*
...
<a id="relationshipdeletebehavior"></a>

###  RelationshipDeleteBehavior

**●  RelationshipDeleteBehavior**:  *`SPTypes.RelationshipDeleteBehaviorType`⎮`number`* 

*Inherited from [IFieldLookup](_definitions_field_field_.ifieldlookup.md).[RelationshipDeleteBehavior](_definitions_field_field_.ifieldlookup.md#relationshipdeletebehavior)*

*Defined in [definitions/field/field.ts:252](https://github.com/gunjandatta/sprest/blob/3de79f1/src/definitions/field/field.ts#L252)*
...
<a id="showinfilterspane"></a>

###  ShowInFiltersPane

**●  ShowInFiltersPane**:  *`number`* 

*Defined in [definitions/field/field.ts:275](https://github.com/gunjandatta/sprest/blob/3de79f1/src/definitions/field/field.ts#L275)*
...
*Defined in [definitions/field/field.ts:278](https://github.com/gunjandatta/sprest/blob/3de79f1/src/definitions/field/field.ts#L278)*
...
*Defined in [definitions/field/field.ts:281](https://github.com/gunjandatta/sprest/blob/3de79f1/src/definitions/field/field.ts#L281)*
...
*Defined in [definitions/field/field.ts:284](https://github.com/gunjandatta/sprest/blob/3de79f1/src/definitions/field/field.ts#L284)*
