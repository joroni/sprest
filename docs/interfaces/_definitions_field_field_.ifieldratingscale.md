[gd-sprest](../README.md) > ["definitions/field/field"](../modules/_definitions_field_field_.md) > [IFieldRatingScale](../interfaces/_definitions_field_field_.ifieldratingscale.md)



# Interface: IFieldRatingScale
...
↳  [IFieldBaseChoice](_definitions_field_field_.ifieldbasechoice.md)
...
*Inherited from [IFieldBaseChoice](_definitions_field_field_.ifieldbasechoice.md).[Choices](_definitions_field_field_.ifieldbasechoice.md#choices)*

*Defined in [definitions/field/field.ts:165](https://github.com/gunjandatta/sprest/blob/3de79f1/src/definitions/field/field.ts#L165)*
...
*Inherited from [IFieldBaseChoice](_definitions_field_field_.ifieldbasechoice.md).[FillInChoice](_definitions_field_field_.ifieldbasechoice.md#fillinchoice)*

*Defined in [definitions/field/field.ts:168](https://github.com/gunjandatta/sprest/blob/3de79f1/src/definitions/field/field.ts#L168)*
...
<a id="gridendnumber"></a>

###  GridEndNumber

**●  GridEndNumber**:  *`number`* 

*Defined in [definitions/field/field.ts:332](https://github.com/gunjandatta/sprest/blob/3de79f1/src/definitions/field/field.ts#L332)*
...
<a id="gridnaoptiontext"></a>

###  GridNAOptionText

**●  GridNAOptionText**:  *`string`* 

*Defined in [definitions/field/field.ts:335](https://github.com/gunjandatta/sprest/blob/3de79f1/src/definitions/field/field.ts#L335)*
...
<a id="gridstartnumber"></a>

###  GridStartNumber

**●  GridStartNumber**:  *`number`* 

*Defined in [definitions/field/field.ts:338](https://github.com/gunjandatta/sprest/blob/3de79f1/src/definitions/field/field.ts#L338)*
...
<a id="gridtextrangeaverage"></a>

###  GridTextRangeAverage

**●  GridTextRangeAverage**:  *`string`* 

*Defined in [definitions/field/field.ts:341](https://github.com/gunjandatta/sprest/blob/3de79f1/src/definitions/field/field.ts#L341)*
...
<a id="gridtextrangehigh"></a>

###  GridTextRangeHigh

**●  GridTextRangeHigh**:  *`string`* 

*Defined in [definitions/field/field.ts:344](https://github.com/gunjandatta/sprest/blob/3de79f1/src/definitions/field/field.ts#L344)*
...
<a id="gridtextrangelow"></a>

###  GridTextRangeLow

**●  GridTextRangeLow**:  *`string`* 

*Defined in [definitions/field/field.ts:347](https://github.com/gunjandatta/sprest/blob/3de79f1/src/definitions/field/field.ts#L347)*
...
*Inherited from [IFieldBaseChoice](_definitions_field_field_.ifieldbasechoice.md).[Mappings](_definitions_field_field_.ifieldbasechoice.md#mappings)*

*Defined in [definitions/field/field.ts:171](https://github.com/gunjandatta/sprest/blob/3de79f1/src/definitions/field/field.ts#L171)*
...
*Defined in [definitions/field/field.ts:350](https://github.com/gunjandatta/sprest/blob/3de79f1/src/definitions/field/field.ts#L350)*
